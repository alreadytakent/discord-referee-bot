...
class BackupManager:
    ...
    def setup_backup_folder(self):
        ...
        try:
            ...
            print(f"❌ Error setting up backup folder: {e}")
    ...
    def backup_database(self, db_path, backup_name):
        ...
        try:
            ...
            file_metadata = {
                'name': f'{backup_name}_{timestamp}.db',
    ...
    def restore_database(self, db_path, backup_name=None):
        ...
        try:
            ...
            query = f"'{self.backup_folder_id}' in parents"
            if backup_name:
            ...
            if not response['files']:
                print(f"ℹ️ No backup found for {backup_name}")
                return False
...
def initialize_backup_system():
    ...
    if os.getenv('RENDER'):
        ...
        if manager.service is None:
            print("❌ Backup system initialization failed - check GOOGLE_SERVICE_ACCOUNT environment variable")
            return None
        ...
        if restored > 0:
            ...
            print("ℹ️ No backups found - starting with fresh databases")
        
        return manager
    
    print("ℹ️ Not running on Render - backup system disabled")
    return None
